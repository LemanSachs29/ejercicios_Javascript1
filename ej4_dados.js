/**
 * ● Descripción: Crea una función que simule el lanzamiento de dos dados 
 * (números aleatorios entre 1 y 6). El programa debe contar cuántas veces se
 *  obtiene un total de 7 al lanzar los dados 100 veces. 
 * ● Requisitos:
...
//Función para simular una tirada de un dado de 6 caras
function dado(){
    return Math.floor(Math.random() * 6) + 1;
}

/**Función que lanza 2 dados 100 veces. Devuelve el número de veces en la que 
